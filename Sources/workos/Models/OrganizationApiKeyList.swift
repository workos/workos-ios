...
public struct OrganizationApiKeyList: Codable, Sendable, Equatable {
    /// Indicates this is a list response.
    public let object: String
    /// The list of records for the current page.
    public let data: [OrganizationApiKey]
    /// Pagination cursors for navigating between pages of results.
    public let listMetadata: OrganizationApiKeyListListMetadata

    public init(
        object: String,
        data: [OrganizationApiKey],
        listMetadata: OrganizationApiKeyListListMetadata
    ) {
        self.object = object
        self.data = data
