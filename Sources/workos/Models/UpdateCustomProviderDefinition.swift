...
public struct UpdateCustomProviderDefinition: Codable, Sendable, Equatable {
    ...
    public let authenticateVia: UpdateCustomProviderDefinitionAuthenticateVia?
    ...
    public init(
        ...
        authenticateVia: UpdateCustomProviderDefinitionAuthenticateVia? = nil
    ) {
        self.name = name
