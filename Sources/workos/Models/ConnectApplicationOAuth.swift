...
public struct ConnectApplicationOAuth: Codable, Sendable, Equatable {
    ...
    public let redirectUris: [ConnectApplicationOAuthRedirectUris]
    ...
    public init(
        ...
        redirectUris: [ConnectApplicationOAuthRedirectUris],
        usesPkce: Bool,
        isFirstParty: Bool,
