...
/// The event payload.
public struct OrganizationDomainDeletedData: Codable, Sendable, Equatable {
    ...
    public let state: OrganizationDomainDeletedDataState?
    ...
    public let verificationStrategy: OrganizationDomainDeletedDataVerificationStrategy?
    ...
    public init(
        ...
        createdAt: Date,
        updatedAt: Date,
        state: OrganizationDomainDeletedDataState? = nil,
        verificationPrefix: String? = nil,
        verificationToken: String? = nil,
        verificationStrategy: OrganizationDomainDeletedDataVerificationStrategy? = nil
    ) {
        self.object = object
        self.id = id
