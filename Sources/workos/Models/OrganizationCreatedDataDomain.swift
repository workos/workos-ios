...
public struct OrganizationCreatedDataDomain: Codable, Sendable, Equatable {
    ...
    public let state: OrganizationCreatedDataDomainState?
    ...
    public let verificationStrategy: OrganizationCreatedDataDomainVerificationStrategy?
    ...
    public init(
        ...
        createdAt: Date,
        updatedAt: Date,
        state: OrganizationCreatedDataDomainState? = nil,
        verificationPrefix: String? = nil,
        verificationToken: String? = nil,
        verificationStrategy: OrganizationCreatedDataDomainVerificationStrategy? = nil
    ) {
        self.object = object
        self.id = id
