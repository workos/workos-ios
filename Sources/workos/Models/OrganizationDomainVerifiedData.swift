...
/// The event payload.
public struct OrganizationDomainVerifiedData: Codable, Sendable, Equatable {
    ...
    public let state: OrganizationDomainVerifiedDataState?
    ...
    public let verificationStrategy: OrganizationDomainVerifiedDataVerificationStrategy?
    ...
    public init(
        ...
        createdAt: Date,
        updatedAt: Date,
        state: OrganizationDomainVerifiedDataState? = nil,
        verificationPrefix: String? = nil,
        verificationToken: String? = nil,
        verificationStrategy: OrganizationDomainVerifiedDataVerificationStrategy? = nil
    ) {
        self.object = object
        self.id = id
