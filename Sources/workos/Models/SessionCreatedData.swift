...
/// The event payload.
public struct SessionCreatedData: Codable, Sendable, Equatable {
    ...
    public let impersonator: SessionCreatedDataImpersonator?
    ...
    public let authMethod: SessionCreatedDataAuthMethod
    /// The current status of the session.
    public let status: SessionCreatedDataStatus
    ...
    public init(
        ...
        createdAt: Date,
        updatedAt: Date,
        impersonator: SessionCreatedDataImpersonator? = nil,
