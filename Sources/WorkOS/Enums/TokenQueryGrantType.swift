...
/// Enumeration of valid TokenQueryGrantType values.
public enum TokenQueryGrantType: RawRepresentable, Codable, Sendable, Hashable {
    ...
    public static let allKnownCases: [TokenQueryGrantType] = [
        .authorizationCode,
