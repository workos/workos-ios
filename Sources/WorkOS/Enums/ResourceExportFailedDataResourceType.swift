...
/// Enumeration of valid ResourceExportFailedDataResourceType values.
public enum ResourceExportFailedDataResourceType: RawRepresentable, Codable, Sendable, Hashable {
    case users
    case organizations
    case events
    case sessions
    ...
    public static let allKnownCases: [ResourceExportFailedDataResourceType] = [
        .users,
        .organizations,
        .events,
        .sessions,
