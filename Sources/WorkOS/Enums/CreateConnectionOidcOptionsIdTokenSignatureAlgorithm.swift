...
/// Enumeration of valid CreateConnectionOidcOptionsIdTokenSignatureAlgorithm values.
public enum CreateConnectionOidcOptionsIdTokenSignatureAlgorithm: RawRepresentable, Codable,
    Sendable, Hashable
{
    case es256
    case es384
    ...
    public static let allKnownCases: [CreateConnectionOidcOptionsIdTokenSignatureAlgorithm] = [
        .es256,
        .es384,
        .es512,
        .edDsa,
