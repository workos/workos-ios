...
/// Enumeration of valid SSOGrantType values.
public enum SSOGrantType: RawRepresentable, Codable, Sendable, Hashable {
    ...
    public static let allKnownCases: [SSOGrantType] = [
        .authorizationCode,
