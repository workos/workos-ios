...
public struct OrganizationDomain: Codable, Sendable, Equatable {
    ...
    public let state: OrganizationDomainState?
    ...
    public let verificationStrategy: OrganizationDomainVerificationStrategy?
    ...
    public init(
        ...
        createdAt: Date,
        updatedAt: Date,
        state: OrganizationDomainState? = nil,
        verificationPrefix: String? = nil,
        verificationToken: String? = nil,
        verificationStrategy: OrganizationDomainVerificationStrategy? = nil
    ) {
        self.object = object
        self.id = id
