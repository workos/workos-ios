...
public struct DataIntegrationList: Codable, Sendable, Equatable {
    /// Indicates this is a list response.
    public let object: String
    /// The list of records for the current page.
    public let data: [DataIntegration]
    /// Pagination cursors for navigating between pages of results.
    public let listMetadata: DataIntegrationListListMetadata

    public init(
        object: String,
        data: [DataIntegration],
        listMetadata: DataIntegrationListListMetadata
    ) {
        self.object = object
        self.data = data
