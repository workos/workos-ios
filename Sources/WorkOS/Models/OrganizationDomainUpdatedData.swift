...
/// The event payload.
public struct OrganizationDomainUpdatedData: Codable, Sendable, Equatable {
    ...
    public let state: OrganizationDomainUpdatedDataState?
    ...
    public let verificationStrategy: OrganizationDomainUpdatedDataVerificationStrategy?
    ...
    public init(
        ...
        createdAt: Date,
        updatedAt: Date,
        state: OrganizationDomainUpdatedDataState? = nil,
        verificationPrefix: String? = nil,
        verificationToken: String? = nil,
        verificationStrategy: OrganizationDomainUpdatedDataVerificationStrategy? = nil
    ) {
        self.object = object
        self.id = id
