...
public struct WebhookEndpointList: Codable, Sendable, Equatable {
    /// Indicates this is a list response.
    public let object: String
    /// The list of records for the current page.
    public let data: [WebhookEndpoint]
    /// Pagination cursors for navigating between pages of results.
    public let listMetadata: WebhookEndpointListListMetadata

    public init(
        object: String,
        data: [WebhookEndpoint],
        listMetadata: WebhookEndpointListListMetadata
    ) {
        self.object = object
        self.data = data
