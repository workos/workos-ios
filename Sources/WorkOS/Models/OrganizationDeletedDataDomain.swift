...
public struct OrganizationDeletedDataDomain: Codable, Sendable, Equatable {
    ...
    public let state: OrganizationDeletedDataDomainState?
    ...
    public let verificationStrategy: OrganizationDeletedDataDomainVerificationStrategy?
    ...
    public init(
        ...
        createdAt: Date,
        updatedAt: Date,
        state: OrganizationDeletedDataDomainState? = nil,
        verificationPrefix: String? = nil,
        verificationToken: String? = nil,
        verificationStrategy: OrganizationDeletedDataDomainVerificationStrategy? = nil
    ) {
        self.object = object
        self.id = id
