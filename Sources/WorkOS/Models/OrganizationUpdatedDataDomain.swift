...
public struct OrganizationUpdatedDataDomain: Codable, Sendable, Equatable {
    ...
    public let state: OrganizationUpdatedDataDomainState?
    ...
    public let verificationStrategy: OrganizationUpdatedDataDomainVerificationStrategy?
    ...
    public init(
        ...
        createdAt: Date,
        updatedAt: Date,
        state: OrganizationUpdatedDataDomainState? = nil,
        verificationPrefix: String? = nil,
        verificationToken: String? = nil,
        verificationStrategy: OrganizationUpdatedDataDomainVerificationStrategy? = nil
    ) {
        self.object = object
        self.id = id
