...
/// The event payload.
public struct SessionRevokedData: Codable, Sendable, Equatable {
    ...
    public let impersonator: SessionRevokedDataImpersonator?
    ...
    public let authMethod: SessionRevokedDataAuthMethod
    /// The current status of the session.
    public let status: SessionRevokedDataStatus
    ...
    public init(
        ...
        createdAt: Date,
        updatedAt: Date,
        impersonator: SessionRevokedDataImpersonator? = nil,
