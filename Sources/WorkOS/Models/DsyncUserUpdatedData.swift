...
/// The event payload.
public struct DsyncUserUpdatedData: Codable, Sendable, Equatable {
    ...
    public let emails: [DsyncUserUpdatedDataEmail]?
    ...
    public let state: DsyncUserUpdatedDataState
    ...
    public init(
        ...
        lastName: String? = nil,
        name: String? = nil,
        emails: [DsyncUserUpdatedDataEmail]? = nil,
        jobTitle: String? = nil,
        username: String? = nil,
        role: SlimRole? = nil,
        roles: [SlimRole]? = nil,
